function newRobot = relAngleSmooth(serial, robot, theta0, theta1, omega0 = 10, omega1 = 10, comm = true)
	...
	if(validCommand)
		...
		message = strcat('p', num2str(dir0, '%01d'), num2str(steps0, '%04d'), num2str(delay0, '%06d'), num2str(dir1, '%01d'), num2str(steps1, '%04d'), num2str(delay1, '%06d'));
